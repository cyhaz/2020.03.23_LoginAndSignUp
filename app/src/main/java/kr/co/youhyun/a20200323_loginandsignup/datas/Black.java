package kr.co.youhyun.a20200323_loginandsignup.datas;
...
//    Calendar => 양식으로 가공해서 String으로 변환
    public String getFormattedCreateAt() {

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy년 M월 d일 a h시 m분 s초");
...
//            Calendar => String 변환
            ...
            black.createdAt.setTime(sdf.parse(json.getString("created_at")));  // Date => Calendar에 담자
